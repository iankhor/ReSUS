...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { blood_type_id: @experiment.blood_type_id } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { blood_type_id: @experiment.blood_type_id } }
